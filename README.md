...
> The trained detector checkpoint (`best_map50_0.73.pt`) is bundled inside the **Khilgaon 14-12** dataset. Point `MODEL_PATH` in the detection notebooks at it, or train your own with `Dataset_Training.ipynb`.
